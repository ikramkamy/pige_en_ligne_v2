...
//   const { EvolutionData, EvolutionDataLast, secondsToHoursObject,
//     baseGraphs, setBaseGraphs } = UseGraphStore((state) => state);
...
//     })
//   })
//   const arrTosortlast = EvolutionDataLast?.heure?.map((e) => {
//     return ({
//       date: e.Date,
//       name: e.interval_end.split(':')[0] + ":" + e.interval_end.split(':')[1],
//       //heure:e.interval_end?.split(':')[0]+":"+ e.interval_end?.split(':')[1],
...
//   let EvolutionDataHeureLast = arrTosortlast
...
//     name: e.Date,
//   })) || [];
//   const EvolutionDataJour2Last = EvolutionDataLast?.jour?.map((e) => ({
//     date: e.Jour,
//     heur: e.heure,
//     total: Number(e.total),
//     name: e.Date,
...
//   const EvolutionDataJourLast = sortDatesAscending(EvolutionDataJour2Last)
...
//   const EvolutionDataMois2Last = EvolutionDataLast?.mois?.map((e) => ({
//     date: e.Date,
//     name: e.Mois,
//     total: Number(e.total),
//     jour: e.Jour,
...
//   const EvolutionDataMoisLast = EvolutionDataMois2Last
...
//   };
//   const dataMappingLast = {
//     heure: EvolutionDataHeureLast,
//     jour: EvolutionDataJourLast,
//     mois: EvolutionDataMoisLast,
//   };
//   const [localColor, setLocalColor] = useState('red')
//   const [localColorLast, setLocalColorLast] = useState('red')
//   const currentData = dataMapping[activeChart] || [];
//   const currentDataLast = dataMappingLast[activeChart] || [];
...
//   const maxarrayLast = EvolutionDataHeureLast?.map((e) => Number(e.total))
//   let maxheure = []
//   // if(media !=="presse"){
...
//     },
//   };
//   const chartConfigLast = {
//     heure: {
//       label: "Heure",
//       //color: "#d81b60",
//       color: localColorLast,
//       total: EvolutionDataLast?.heure?.length,
//       max: maxarrayLast ? findMax(maxarrayLast) : 0,
//       min: media !== "presse" ? getMinvalue(EvolutionDataHeureLast) : 0,
//     },
//     jour: {
//       label: "Jour",
//       color: localColorLast,
//       total: EvolutionDataLast?.jour?.length,
//       max: EvolutionDataJourLast[0]?.total,
//       min: EvolutionDataJourLast ? getMinvalue(EvolutionDataJourLast) : 0,

//     },
//     mois: {
//       label: "Mois",
//       color: localColorLast,
//       total: EvolutionDataLast?.mois?.length,
//       max: EvolutionDataMoisLast[0]?.total,
//       min: getMinvalue(EvolutionDataMoisLast),
//     },
//   };
//   const total = useMemo(() => {
//     return {
...
//       mois: "",
//     };
//   }, [EvolutionDataHeureLast, EvolutionDataJourLast, EvolutionDataMoisLast]);
...
//   ];
//   const colorMapping2 = [
//     { value: 'volume', codeColor: '#43a064' },
//     { value: 'budget', codeColor: '#2196d3' },
//     { value: 'duree', codeColor: '#d81b92' }
//   ];
//   const getColorByValue = (value) => {
//     const item = colorMapping.find(item => item.value === value);
//     return item ? item.codeColor : '#blue';
//   }
//   const getColorByValueLast = (value) => {
//     const item = colorMapping2.find(item => item.value === value);
//     return item ? item.codeColor : '#blue';
//   }
//   useEffect(() => {
//     let LocalColor = getColorByValue(LocalBaseGraph)
//     let LocalColorlast = getColorByValueLast(LocalBaseGraph)
//     setLocalColor(LocalColor)
//     setLocalColorLast(LocalColorlast)
//   }, [baseGraphs, isloading, EvolutionData, base, EvolutionDataLast])
...
//   const maxLast = Number(chartConfigLast[activeChart]?.max)
//   const minLast = Number(chartConfigLast[activeChart]?.min)
...
//           {/* <Legend
//             wrapperStyle={{ bottom: 10, right: 10, zIndex: 1 }}
